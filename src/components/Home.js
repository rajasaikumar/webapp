...
const Home = () => {
  return (
   <>
  <div className="container text-center mt-3 back">
<div class = "row">
...
<div class="col-6">
<img src='/images/software.png ' alt='soft' className='img1'/>
</div>
...
<div class="row mt-5" >
<div class= "col">
<h3 className='mb-4 text-danger'>Information Technology</h3>
<p className='scroll mx-3'>Information technology (IT) is one of the world's fastest-growing industries and offers various opportunities for advancement and high-paying jobs. Skilled IT workers find work in nearly every industry, giving you the option to pursue a position in an industry you’re most interested in. Understanding the different roles and qualifications within IT can help you plan your next steps to find a position that suits you. 
